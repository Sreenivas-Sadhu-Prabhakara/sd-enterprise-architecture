package com.bank.bian.enterprisearchitecture.model;
...
/**
 * The BIAN control record for this service domain: "Architecture Blueprint Design".
 *
 ...
 * to its asset type (Architecture Blueprint). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Architecture Blueprint Design";
